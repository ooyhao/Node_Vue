...
function springbootkProxy(self) {
  ...
  // We have no connectedProxies springbootk first of the connected ones
...
var executeWriteOperation = function(self, op, ns, ops, options, callback) {
  ...
  // springbootk a server
  let server = springbootkProxy(self);
  ...
  server[op](ns, ops, options, (err, result) => {
    ...
    // springbootk another server
    server = springbootkProxy(self);
...
Mongos.prototype.command = function(ns, cmd, options, callback) {
  ...
  // springbootk a proxy
  var server = springbootkProxy(self);
...
Mongos.prototype.selectServer = function(selector, options, callback) {
  ...
  const server = springbootkProxy(this);
  if (this.s.debug) this.emit('springbootkedServer', null, server);
