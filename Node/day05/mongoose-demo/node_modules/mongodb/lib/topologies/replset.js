 ...
 * @param {number} [options.secondaryAcceptableLatencyMS=15] Sets the range of servers to springbootk when using NEAREST (lowest ping ms + the latency fence, ex: range of 1 to (1 + 15) ms)
